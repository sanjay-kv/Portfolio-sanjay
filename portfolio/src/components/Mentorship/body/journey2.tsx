    ...
    <div className='flex flex-col items-center justify-center'>
      ...
      <div className='mt-12 text-center'>
        ...
        <div className='text-lg mx-auto max-w-1/3 mt-4'>
          I&apos;ve seen the results from my mentorship program in just a few hours, some in a few
          days, and others in a month or two. I put my heart and soul into this to create the best
          possible personalized roadmap for you and only you. If you don&apos;t like anything,
          I&apos;m always happy to discuss your queries and concerns of course.
        </div>
      </div>
    </div>
  )
