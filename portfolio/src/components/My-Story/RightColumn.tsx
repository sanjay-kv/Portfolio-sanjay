  ...
  <div className='w-full md:w-[55%] p-6 md:p-12 flex flex-col justify-start items-center'>
    ...
    <div className='text-center mt-12 text-lg'>
      ...
      <div className='mt-4 leading-loose'>
        I pack my heart and soul and <HighlightedText tag='p' text='everything I know' /> about{' '}
        <br /> data analysis into my data <HighlightedText tag='p' text='solutions' /> in the form
        of digital <br /> products/services to help you{' '}
        <HighlightedText tag='p' text='get your next job.' />
      </div>
    </div>
    <div className='flex flex-col w-1/2 font-bold'>
      ...
      <button type='button' className='btn-secondary mt-8 uppercase'>
        BOOK A 1-1 SESSION
      </button>
    </div>
  </div>
