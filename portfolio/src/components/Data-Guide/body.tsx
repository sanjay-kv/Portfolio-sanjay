      ...
      <div className="max-w-2xl">
        ...
        <div className="mt-6 space-y-4">
          ...
          <h3 className="text-xl font-bold mt-4">
            The <CircleStrokeText height={52} width={262} text="ULTIMATE DATA ROADMAP" /> will help you with your first formula in Excel.
          </h3>
          ...
          <HighlightedText tag='h3' text="You'll have the essential Soft Skills and Domain Knowledge to succeed in the data world." />
