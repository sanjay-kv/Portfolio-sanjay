              ...
              {testimonials.map((_, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-2.5 h-2.5 text-background rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-foreground ${Math.floor(currentIndex / 4) === Math.floor(slideIndex / 4)
                      ? 'bg-foreground'
