...
const Error = ({ error, reset }: { error: Error; reset: () => void }) => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-b from-gray-900 via-blue-900 to-amber-900 flex flex-col items-center justify-center text-foreground">
      ...
      <svg className="absolute w-full h-full opacity-10 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        <motion.path
      ...
      >
        ...
        >
          <motion.div
            ...
            animate={{
              boxShadow: ["0 0 0 0 rgba(220, 38, 38, 0)", "0 0 0 10px rgba(220, 38, 38, 0.2)", "0 0 0 20px rgba(220, 38, 38, 0)"],
            }}
        ...
        >
          ERROR CODE: {Math.floor(Math.random() * 10000).toString().padStart(4, '0')}
        </motion.div>
          ...
          {Array.from("Something went wrong!").map((letter, i) => (
            <motion.span
              ...
              style={{
                ...
                textShadow: i % 3 === 0 ? '0 0 5px #f0f' : i % 3 === 1 ? '0 0 5px #0ff' : '0 0 5px #fff'
              }}
            >
              {letter === ' ' ? '\u00A0' : letter}
            </motion.span>
