...
const RelatedProjects: React.FC<RelatedProjectsProps> = ({
  ...
  return (
    <section className="py-16 bg-gray-900" aria-labelledby="related-projects-heading">
          ...
          {relatedProjects.map((project, index) => (
            ...
            >
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-medium group-hover:text-primary transition-colors duration-300">{project.title}</h3>
